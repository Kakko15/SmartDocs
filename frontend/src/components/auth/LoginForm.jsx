  ...
  return (
    <form onSubmit={handleSignIn} className="space-y-6">
       ...
       <motion.button
          ...
          type="submit"
          disabled={loading}
          className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3.5 rounded-full shadow-lg shadow-green-500/20 transition-all text-sm uppercase tracking-wider disabled:opacity-70 disabled:grayscale"
        >
